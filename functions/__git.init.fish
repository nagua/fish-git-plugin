function __git.init
  ...
  alias ggpnp         __git.push_and_pull_current_branch
  # Deprecated: ggpur
  abbr -a g           git
  abbr -a ga          git add
  ...
  abbr -a gbnm        git branch --no-merge
  ...
  abbr -a gcb         git checkout -a
  abbr -a gcB         git checkout -B
  abbr -a gcd         'git checkout (__git.develop_branch)'
  ...
  alias gccd          __git.clone_and_change_dir
  ...
  alias gdv           __git.diff_word_and_view
  abbr -a gdup        git diff @{upstream}
  alias gdnolock      __git.diff_without_lock
  ...
  # Deprecated: abbr -a ggpull      'git pull origin (__git.current_branch)'
  alias ggl           __git.pull_or_pull_current_branch
  ...
  alias ggf           __git.push_or_push_current_branch_force
  abbr -a gpf         git push --force-with-lease --force-if-includes
  alias ggfl          __git.push_or_push_current_branch_force_with_lease
  abbr -a gpsup       'git push --set-upstream origin (__git.current_branch)'
  abbr -a gpsupf      'git push --set-upstream origin (__git.current_branch) --force-with-lease --force-if-includes'
  abbr -a gpv         git push --verbose
  abbr -a gpoat       'git push origin --all && git push origin --tags'
  abbr -a gpod        git push origin --delete
  # Deprecated: abbr -a ggpush      'git push origin (__git.current_branch)'
  alias ggp           __git.push_or_push_current_branch
  ...
  abbr -a grbd        'git rebase (__git.develop_branch)'
  abbr -a grbm        'git rebase (__git.default_branch)'
  abbr -a grbom       'git rebase origin/(__git.default_branch)'
  ...
  abbr -a git-svn-dcommit-push 'git svn dcommit && git push github (__git.default_branch):svntrunk'
  abbr -a gsr         git svn rebase
  abbr -a gsw         git switch
  abbr -a gswc        git switch -c
  abbr -a gswd        'git switch (__git.develop_branch)'
  abbr -a gswm        'git switch (__git.default_branch)'
  abbr -a gta         git tag --annotate
  abbr -a gts         git tag -s
  abbr -a gtv         'git tag | sort -V'
  abbr -a gignore     git update-index --assume-changed
